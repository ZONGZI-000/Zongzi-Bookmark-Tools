...
try {
  importScripts(
    ...
    'background/summary/db.js',
    'background/sync/webdav.js',
    'background/sync/versioning.js',
    'background/sync/state.js',
    'background/sync/providers.js',
    'background/sync/validation.js',
